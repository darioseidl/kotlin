...
object IrTree : AbstractTreeBuilder() {
    ...
    private fun descriptor(typeName: String) = field("descriptor", ClassRef<TypeParameterRef>(TypeKind.Interface, "org.jetbrains.kotlin.descriptors", typeName))
    ...
    val `class` by element(Declaration) {
        ...
        +field("inlineClassRepresentation", type<InlineClassRepresentation<*>>().withArgs(type(Packages.types, "IrSimpleType")), nullable = true, mutable = true)
