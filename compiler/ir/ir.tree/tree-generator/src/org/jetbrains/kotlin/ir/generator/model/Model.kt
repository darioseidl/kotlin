...
class Element(
    ...
    enum class Kind(val typeKind: TypeKind, val hasLeafBuilder: Boolean, val isInterface: Boolean) {
        FinalClass(TypeKind.Class, hasLeafBuilder = true, isInterface = false),
        OpenClass(TypeKind.Class, hasLeafBuilder = true, isInterface = false),
        AbstractClass(TypeKind.Class, hasLeafBuilder = false, isInterface = false),
        SealedClass(TypeKind.Class, hasLeafBuilder = false, isInterface = false),
        Interface(TypeKind.Interface, hasLeafBuilder = false, isInterface = true),
        SealedInterface(TypeKind.Interface, hasLeafBuilder = false, isInterface = true),
    }
