...
class JavaClassUseSiteMemberScope(
    ...
    private fun FirNamedFunctionSymbol.doesOverrideSuspendFunction(): Boolean {
        ...
        return supertypeScopeContext.scopes.any { scope ->
...
//                 processOverridesForFunctionsWithErasedValueParameter
                val unwrappedSubstitutionOverride = overriddenMemberWithErasedValueParameters.fir.originalForSubstitutionOverride ?: overriddenMemberWithErasedValueParameters.fir
...
//                    it.fir.valueParameters.size == functionFromSupertypeWithErasedParameterType.fir.valueParameters.size &&
//                    overrideChecker.isOverriddenFunction(it, functionFromSupertypeWithErasedParameterType) && !it.isVisibleInCurrentClass()
    ...
    private fun FirPropertySymbol.isOverriddenInClassBy(functionSymbol: FirNamedFunctionSymbol): Boolean {
        ...
        return accessorDescriptors.any { (getterJvmDescriptor, setterJvmDescriptor) ->
            currentJvmDescriptor == getterJvmDescriptor || currentJvmDescriptor == setterJvmDescriptor
        }
    }
